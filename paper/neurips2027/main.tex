...
paper into a universal scaler leaderboard? Neural pilots remain exploratory and
are not used as central evidence.
...
training evidence was used, which candidates were rejected, and which tests
could falsify the choice. That shift from unnamed preprocessing to checked
invariance compilation is the contribution.
