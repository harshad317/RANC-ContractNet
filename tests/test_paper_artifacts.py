...
def test_main_paper_wires_first_decisive_result():
    ...
    for phrase in [
        ...
        "\\subsection{Threats to validity and failure detection}",
        "checker coverage is relative rather than global",
        ...
        "RANC exposes rather than eliminates these threats",
...
def test_paper_claims_boundary_avoids_overclaiming_language():
    ...
    for phrase in [
        "paper-revision-draft-2026-06-04-v6",
        "artifact-complete local draft",
        "Included Scope",
