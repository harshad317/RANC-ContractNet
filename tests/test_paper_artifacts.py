...
def test_main_paper_wires_first_decisive_result():
    ...
    for phrase in [
        ...
        "relative to the declared contract and checkers",
        "does not prove semantic truth, downstream optimality",
        "The paper makes five contributions",
        "uses hard clauses rather than validation outcomes",
        "The experiments are organized as falsification tests",
        "The evidence chain is ordered by claim strength",
        ...
        "Panel B plots the paired semantic deltas",
        "figures/ranc_visual_summary.pdf",
        "Paired outlier worlds",
        "Artifact checks",
        "clean extracted-bundle dry runs",
        "The paired outlier benchmark tests contract causality directly",
        "Decisive semantic intervention on paired outlier worlds",
        "Artifact-level safety evidence for hard clauses",
        "Public-data execution evidence on OpenML/UCI",
        "Sparse and temporal checks test representation and split-safety failures",
        ...
        "The main empirical takeaway is an ordered evidence chain",
        "strongest evidence for that claim is the paired",
        "OpenML/UCI results are therefore supportive but not central",
        ...
        "The approach would be falsified by future preregistered runs",
